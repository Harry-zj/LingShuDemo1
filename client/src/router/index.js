...
const routes = [
  ...
  { path: "/module3/class-leader", name: "ClassLeaderDesk", component: () => import("../views/module3/ClassLeaderDesk.vue"), meta: { layout: "main", title: "待评表单" } },
  { path: "/module3/counselor", name: "CounselorConsole", component: () => import("../views/module3/CounselorConsole.vue"), meta: { layout: "main", title: "辅导员工作台" } },
