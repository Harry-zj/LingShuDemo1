...
.stats-row { display:grid; grid-template-columns:repeat(3,1fr); gap:16px; }.stat-card { padding:20px; border-radius: 8px; background:var(--color-surface); border:1px solid var(--color-border); display:grid; grid-template-columns:auto 1fr; gap:6px 12px; align-items:center; }.stat-icon { grid-row:span 2; font-size:30px; }.stat-num { font-size:24px; font-weight:600; }.stat-lbl { color:var(--color-text-secondary); font-size:13px; }.warning .stat-icon { color:#f59e0b; }.success .stat-icon { color:#34a853; }.error .stat-icon { color:#ef4444; }
.review-list { padding:20px; border-radius: 8px; }.panel-header { display:flex; justify-content:space-between; align-items:center; margin-bottom:16px; }.panel-header h3 { display:flex; align-items:center; gap:8px; font-size:16px; }.panel-badge { font-size:13px; color:var(--color-primary); }.student-list { display:flex; flex-direction:column; gap:10px; }.student-row { display:flex; justify-content:space-between; align-items:center; gap:16px; padding:14px; border-radius: 8px; background:var(--color-bg); cursor:pointer; }.student-row:hover { transform:translateY(-1px); box-shadow:var(--shadow-level-1); }.student-main { display:flex; align-items:center; gap:12px; }.student-icon { font-size:28px; color:var(--color-primary); }.student-name { font-weight:600; display:flex; align-items:center; gap:8px; }.review-stage { padding:3px 8px; border-radius: 8px; background:rgba(245,158,11,.12); color:#d97706; font-size:11px; }.student-meta { color:var(--color-text-secondary); font-size:13px; margin-top:4px; }.student-status { display:flex; align-items:center; gap:8px; color:var(--color-primary); white-space:nowrap; }.empty-state { display:flex; flex-direction:column; align-items:center; gap:8px; padding:32px; color:var(--color-text-tertiary); }
