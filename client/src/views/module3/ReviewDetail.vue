...
.btn-outline { display: inline-flex; align-items: center; gap: 6px; height: 38px; padding: 0 14px; border-radius: 8px; border: 1px solid var(--color-border); background: var(--color-surface); color: var(--color-text-primary); cursor: pointer; }
.assignment-card, .review-box, .item-review-box { padding: 20px; border-radius: 8px; }
...
.stage-tag, .objection-tag { padding: 5px 10px; border-radius: 8px; background: rgba(245,158,11,.12); color: #d97706; }
.task-list { display: flex; flex-wrap: wrap; gap: 8px; }
.task-list span { padding: 6px 10px; border-radius: 8px; background: var(--color-bg); font-size: 13px; color: var(--color-text-secondary); }
.item-review-list { display: flex; flex-direction: column; gap: 12px; }
.item-review-card { padding: 14px; border: 1px solid var(--color-border); border-radius: 8px; background: var(--color-bg); }
...
.item-fields select, .item-fields input { min-height: 38px; padding: 0 10px; border: 1px solid var(--color-border); border-radius: 8px; background: var(--color-surface); color: var(--color-text-primary); }
...
.template-row button { border: 1px solid var(--color-border); border-radius: 8px; background: var(--color-surface); color: var(--color-text-secondary); padding: 5px 10px; cursor: pointer; }
.level-row { padding: 14px; border-radius: 8px; background: var(--color-bg); margin-bottom: 14px; }
...
.level-options button { height: 34px; padding: 0 14px; border-radius: 8px; border: 1px solid var(--color-border); background: var(--color-surface); color: var(--color-text-primary); cursor: pointer; }
...
textarea { width: 100%; min-height: 86px; border: 1px solid var(--color-border); border-radius: 8px; background: var(--color-surface); color: var(--color-text-primary); padding: 12px; resize: vertical; }
.actions { display: flex; gap: 10px; flex-wrap: wrap; margin-top: 14px; }
.actions button { display: inline-flex; align-items: center; gap: 6px; height: 38px; padding: 0 14px; border-radius: 8px; border: none; color: white; cursor: pointer; }
