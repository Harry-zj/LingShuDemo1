...
.panel-card { display: flex; flex-direction: column; gap: 14px; padding: 24px; border-radius: 8px; }
...
input, select, textarea { min-height: 40px; border: 1px solid var(--color-border); border-radius: 8px; padding: 8px 12px; background: var(--color-bg); color: var(--color-text-primary); }
...
.grade-row { display: flex; align-items: center; gap: 8px; padding: 10px; border-radius: 8px; background: var(--color-bg); }
...
.batch-row { display: flex; justify-content: space-between; gap: 16px; padding: 14px; border-radius: 8px; background: var(--color-bg); }
...
.assignment-row { display: grid; grid-template-columns: 1fr 1fr auto; gap: 10px; align-items: start; padding: 12px; border-radius: 8px; background: var(--color-bg); }
.small { min-height: 34px; }
.empty-line { padding: 24px; text-align: center; color: var(--color-text-tertiary); }
.history-tip { padding: 10px 12px; border-radius: 8px; background: rgba(245, 158, 11, 0.10); color: #b45309; font-size: 13px; }
