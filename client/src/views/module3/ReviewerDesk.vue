...
button { border: none; border-radius: 8px; padding: 10px 14px; cursor: pointer; background: #e5e7eb; }
.panel, .form-card, .bonus-card { background: #fff; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; display: grid; gap: 16px; }
...
.evidence span { background: #fff; border: 1px solid #e5e7eb; border-radius: 8px; padding: 4px 10px; font-size: 13px; }
textarea { min-height: 84px; border: 1px solid #d1d5db; border-radius: 8px; padding: 12px; resize: vertical; }
