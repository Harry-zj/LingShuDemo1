...
const modules = [
  ...
  { title: '个性评定', desc: '五维评分·雷达图·班级对比', path: '/module2/evaluation', icon: 'mdi:chart-bell-curve', iconBg: 'rgba(217,119,6,0.08)', meridianColor: '#D97706', tag: '分析' },
  { title: '评定报告', desc: '智能评语·改进建议·PDF导出', path: '/module2/report', icon: 'mdi:file-document-outline', iconBg: 'rgba(6,182,212,0.08)', meridianColor: '#06B6D4', tag: '输出' },
