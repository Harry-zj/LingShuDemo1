...
const modules = [
  ...
  { title: '批量填表', desc: '一键批量生成多人文档，告别重复劳动', path: '/zongce/batch-fill', icon: 'mdi:file-multiple-outline', iconBg: 'rgba(5,150,105,0.08)', meridianColor: '#059669', tag: '提效' },
  { title: '对话填表', desc: 'AI引导式提问，边聊边填', path: '/zongce/chat-fill', icon: 'mdi:chat-processing-outline', iconBg: 'rgba(124,58,237,0.08)', meridianColor: '#7C3AED', tag: '智能' },
