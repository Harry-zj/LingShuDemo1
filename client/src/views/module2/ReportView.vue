<template>
  <div class="stub-page">
    <div class="page-header">
      <h2>个性化评定报告</h2>
      <p class="page-desc">智能评语、多模板报告、PDF导出</p>
    </div>
    <div class="stub-card">
      <div class="stub-icon-wrapper">
        <VIcon icon="mdi:file-document-outline" class="stub-icon" />
      </div>
      <h3>功能开发中</h3>
      <p>该功能由组员实现，即将上线</p>
      <div class="skeleton-preview">
        ...
        <div class="skeleton skeleton-card" style="height: 100px; margin-top: 12px"></div>
      </div>
    </div>
  </div>
</template>
...
.stub-icon { font-size: 36px; color: #009688; }
