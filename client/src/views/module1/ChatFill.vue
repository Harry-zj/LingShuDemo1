...
﻿<template>
  <div class="stub-page">
    <div class="page-header">
      <h2>对话式填表</h2>
      <p class="page-desc">以轻松对话方式，AI引导逐步完成填表</p>
    </div>
    <div class="stub-card">
      <div class="stub-icon-wrapper">
        <VIcon icon="mdi:chat-processing-outline" class="stub-icon" />
      </div>
      <h3>功能开发中</h3>
      <p>该功能由组员实现，即将上线</p>
      <div class="skeleton-preview">
        ...
        <div class="skeleton skeleton-card" style="height: 160px; margin-top: 12px"></div>
      </div>
    </div>
  </div>
</template>
...
=======
<template><div class="stub"><h2>对话式填表</h2><p>该功能由组员实现 - 以轻松对话方式完成信息填写</p></div></template>
>>>>>>> origin/main
