...
.upload-right { display: flex; flex-direction: column; gap: 10px; }
.upload-right textarea { flex: 1; resize: vertical; font-family: inherit; font-size: 14px; padding: 10px; border: 1px solid var(--color-border); border-radius: var(--radius-md); }
...
.source-list, .rule-sets-list { display: flex; flex-direction: column; gap: 8px; }
.source-row { display: flex; align-items: center; gap: 12px; font-size: 14px; }

.ruleset-list-header { display: flex; align-items: center; justify-content: space-between; }
.ruleset-check { margin: 0 4px 0 0; cursor: pointer; }
.ruleset-card { border: 1px solid var(--color-border); border-radius: var(--radius-md); overflow: hidden; }
.ruleset-header {
  display: flex; align-items: center; gap: 10px; padding: 12px 16px;
  cursor: pointer; background: #fafbfc; user-select: none;
}
.ruleset-header:hover { background: #f0f4f8; }
.ruleset-arrow { font-size: 12px; color: #999; width: 16px; }
.ruleset-label { font-weight: 600; font-size: 15px; }
.ruleset-meta { font-size: 12px; color: #999; margin-left: auto; }

.badge { font-size: 11px; padding: 2px 8px; border-radius: 10px; font-weight: 500; }
.badge.parsed { background: #e6f4ea; color: #34A853; }
.badge.pending { background: #fef7e0; color: #EA8600; }
.badge.draft { background: #fef7e0; color: #EA8600; }
.badge.published { background: #e6f4ea; color: #34A853; }

.ruleset-body { padding: 12px 16px; border-top: 1px solid #f0f0f0; }
.detail-section { margin-bottom: 16px; }
.detail-section h5 { font-size: 13px; color: #555; margin: 0 0 8px; padding-bottom: 4px; border-bottom: 1px solid #f0f0f0; }

.ind-node { font-size: 13px; padding: 2px 0; display: flex; gap: 12px; align-items: baseline; }
.ind-code { font-weight: 600; color: var(--color-primary); min-width: 50px; }
.ind-name { color: #333; }
.ind-meta { font-size: 11px; color: #999; }

.pkg-card { border: 1px solid #eee; border-radius: 6px; padding: 8px 12px; margin-bottom: 8px; }
.pkg-header { display: flex; gap: 10px; align-items: baseline; margin-bottom: 4px; }
.pkg-name { font-weight: 600; font-size: 13px; }
.pkg-key { font-size: 11px; color: #999; font-family: monospace; }
.pkg-level { font-size: 10px; padding: 1px 6px; border-radius: 3px; background: #fff3cd; }
.rule-row { display: flex; gap: 8px; font-size: 12px; padding: 2px 0; }
.rule-type { font-weight: 600; color: #1A73E8; min-width: 70px; }
.rule-name { flex: 1; }
.rule-stage { color: #999; min-width: 100px; }
.rule-scope { color: #999; min-width: 70px; }
...
.btn.primary.sm { padding: 4px 12px; font-size: 12px; }
.btn-text { background: none; border: none; cursor: pointer; font-size: 13px; font-family: inherit; }
.btn-text.primary { color: var(--color-primary); }
.btn-text.danger { color: #EA4335; }
